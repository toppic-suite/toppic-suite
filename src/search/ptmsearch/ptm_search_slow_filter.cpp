...
PtmSearchSlowFilter::PtmSearchSlowFilter(const SpectrumSetPtr &spectrum_set_ptr,
...
PrsmPtrVec PtmSearchSlowFilter::getPrsms(int shift_num, const PrsmParaPtr &prsm_para_ptr, 
