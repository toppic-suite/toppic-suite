  ...
  for (int s = 2; s <= n_unknown_shift; s++) {
    ...
    for (int t = 0; t < mng_ptr_->thread_num_; t++) {
      std::string input_ext = mng_ptr_->output_file_ext_ + "_" 
          + std::to_string(t) + "_" + ProteoformType::COMPLETE->getName() + end_str;
    ...
    for (int t = 0; t < mng_ptr_->thread_num_; t++) {
      std::string input_ext = mng_ptr_->output_file_ext_ + "_" 
          + std::to_string(t) + "_" + ProteoformType::PREFIX->getName() + end_str;
    ...
    for (int t = 0; t < mng_ptr_->thread_num_; t++) {
      std::string input_ext = mng_ptr_->output_file_ext_ + "_" 
          + std::to_string(t) + "_" + ProteoformType::SUFFIX->getName() + end_str;
    ...
    for (int t = 0; t < mng_ptr_->thread_num_; t++) {
      std::string input_ext = mng_ptr_->output_file_ext_ + "_" 
          + std::to_string(t) + "_" + ProteoformType::INTERNAL->getName() + end_str;
