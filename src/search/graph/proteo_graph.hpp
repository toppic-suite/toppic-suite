...
class ProteoGraph {
 public:
  ProteoGraph(const FastaSubSeqPtr& seq_ptr, const ModPtrVec& fix_mod_ptr_vec,
              const MassGraphPtr& graph_ptr, bool is_nme, double convert_ratio,
              int max_mod_num, int max_ptm_sum_mass, int proteo_graph_gap,
              int var_ptm_in_gap);
