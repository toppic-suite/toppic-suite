...
#ifndef TOPPIC_SEARCH_ONEPTMSEARCH_PTM_SEARCH_MNG_HPP_
#define TOPPIC_SEARCH_ONEPTMSEARCH_PTM_SEARCH_MNG_HPP_
...
class PtmSearchMng {
 public:
  PtmSearchMng(const PrsmParaPtr& prsm_para_ptr, int n_report,
               double align_min_shift, double align_max_shift, int shift_num,
               int thread_num, const std::string& input_file_ext,
  ...
  int min_diagonal_gap_ =
      static_cast<int>(ptm_fast_filter_scale_ * min_double_gap_);
