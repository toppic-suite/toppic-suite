...
class PsAlign {
 public:
  PsAlign(const std::vector<double>& ms_masses,
          ...
          const DiagonalPtrVec& diagonal_ptrs, const PsAlignParaPtr& para_ptr);
  ...
  PrsmPtr geneResult(int shift_num, const ProteoformPtr& proteo_ptr,
 ...
 protected:
  ...
  DpPairPtr getTruncPre(const DpPairPtr& cur_pair_ptr, int s,
