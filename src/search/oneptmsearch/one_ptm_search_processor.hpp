...
#ifndef TOPPIC_SEARCH_ONEPTMSEARCH_ONE_PTM_SEARCH_PROCESSOR_HPP_
#define TOPPIC_SEARCH_ONEPTMSEARCH_ONE_PTM_SEARCH_PROCESSOR_HPP_
...
class OnePtmSearchProcessor {
 public:
  explicit OnePtmSearchProcessor(const PtmSearchMngPtr &mng_ptr): mng_ptr_(mng_ptr) {}
  void process();

 private:
  PrsmPtrVec onePtmSearchOneSpec(const SpectrumSetPtr &spec_set_ptr,
