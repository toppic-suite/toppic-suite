...
#ifndef TOPPIC_SEARCH_VARPTMSEARCH_VAR_PTM_SEARCH_MNG_HPP_
#define TOPPIC_SEARCH_VARPTMSEARCH_VAR_PTM_SEARCH_MNG_HPP_
...
class VarPtmSearchMng {
 public:
  VarPtmSearchMng(const PrsmParaPtr& prsm_para_ptr, int n_report,
                  const std::string& var_ptm_file_name, int var_ptm_num,
