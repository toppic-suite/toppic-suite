...
#ifndef TOPPIC_SEARCH_VARPTMSEARCH_VAR_PTM_SLOW_MATCH_HPP_
#define TOPPIC_SEARCH_VARPTMSEARCH_VAR_PTM_SLOW_MATCH_HPP_
...
class VarPtmSlowMatch {
 public:
  VarPtmSlowMatch(const ProteoformPtr &proteo_ptr,
...
using VarPtmSlowMatchPtr = std::shared_ptr<VarPtmSlowMatch>;
using VarPtmSlowMatchPtrVec = std::vector<VarPtmSlowMatchPtr>;
