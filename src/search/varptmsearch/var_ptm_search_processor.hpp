...
#ifndef TOPPIC_SEARCH_VARPTMSEARCH_VAR_PTM_SEARCH_PROCESSOR_HPP_
#define TOPPIC_SEARCH_VARPTMSEARCH_VAR_PTM_SEARCH_PROCESSOR_HPP_
...
class VarPtmSearchProcessor {
 public:
  explicit VarPtmSearchProcessor(const VarPtmSearchMngPtr &mng_ptr): mng_ptr_(mng_ptr) {}
  void process();

 private:
  PrsmPtrVec varPtmSearchOneSpec(const SpectrumSetPtr &spec_set_ptr,
