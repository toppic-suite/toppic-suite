...
#ifndef TOPPIC_SEARCH_ZEROPTMSEARCH_ZERO_PTM_FAST_MATCH_HPP_
#define TOPPIC_SEARCH_ZEROPTMSEARCH_ZERO_PTM_FAST_MATCH_HPP_
...
class ZeroPtmFastMatch {
 public:
  ZeroPtmFastMatch(const ProteoformPtr &proteo_ptr, double score, int begin, int end);
