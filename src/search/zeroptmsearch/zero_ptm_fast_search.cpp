 ...
 */
double compDiagScr(const ExtendMsPtr &ms_ptr,
...
double compScore(const ExtendMsPtr &ms_ptr, const ProteoformPtr &proteo_ptr, double n_shift,
                 double c_shift) {
...
double compScore(const ExtendMsPtrVec &ms_ptr_vec, const ProteoformPtr &proteo_ptr,
