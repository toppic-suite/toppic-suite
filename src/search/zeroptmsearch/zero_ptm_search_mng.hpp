...
#ifndef TOPPIC_SEARCH_ZEROPTMSEARCH_ZERO_PTM_SEARCH_MNG_HPP_
#define TOPPIC_SEARCH_ZEROPTMSEARCH_ZERO_PTM_SEARCH_MNG_HPP_
...
class ZeroPtmSearchMng {
 public:
  ZeroPtmSearchMng(const PrsmParaPtr &prsm_para_ptr,
