...
#ifndef TOPPIC_SEARCH_VAR_PTM_SEARCH_VAR_PTM_PAIR_HPP_
#define TOPPIC_SEARCH_VAR_PTM_SEARCH_VAR_PTM_PAIR_HPP_
...
class VarPtmDpPair;
typedef std::shared_ptr<VarPtmDpPair>  VarPtmDpPairPtr;
typedef std::vector<VarPtmDpPairPtr> VarPtmDpPairPtrVec;

class VarDpPair : public Pair{
 public:
 VarDpPair(int x,int y,double pair_score,
