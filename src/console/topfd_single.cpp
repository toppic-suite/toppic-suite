...
#include "console/topfd_single_argument.hpp"
#include "console/topfd_single_process.hpp"
...
int main(int argc, char* argv[]) {
  ...
  int result = toppic::topfd_single_process::process(arguments, spec_file_lst);
