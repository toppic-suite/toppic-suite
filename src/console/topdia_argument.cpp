  ...
  try {
    ...
    display_desc.add_options()("help,h", "Print this help message.")(
        ...
        ("ms1-ecscore-cutoff,t", po::value<std::string>(&ms1_ecscore_cutoff),
         "<a positive number in [0,1]>. Set the MS1 ECScore cutoff value for "
         "proteoform features. The default value is 0.")(
            "ms2-ecscore-cutoff,T", po::value<std::string>(&ms2_ecscore_cutoff),
            "<a positive number in [0,1]>. Set the MS2 ECScore cutoff value "
            "for proteoform features. The default value is 0")
            ...
            ("ms1-min-scan-number,b", po::value<std::string>(&ms1_min_scan_num),
             ...
             "feature is detected. The default value is 2.")(
                "ms2-min-scan-number,B",
                po::value<std::string>(&ms1_min_scan_num),
                "<1|2|3>. The minimum number of MS2 scans in which a "
                "proteoform feature is detected. The default value is 1.")(
                "single-scan-noise,i",
                "Use the peak intensity noise levels in single MS1 scans to "
                "filter out low intensity peaks in proteoform feature "
                "detection. The default method is to use the peak intensity "
                "noise level of the whole LC-MS map to filter out low "
                "intensity peaks.")

                ("pseudo-cutoff,v",
                 po::value<std::string>(&pseudo_score_cutoff),
                 "<a positive number in [0,1]>. Set the Pseudo Score cutoff "
                 "value for generating pseudo-MS/MS spectrum. The default "
                 "value is 0.55")("pseudo-peak-number,V",
                                  po::value<std::string>(&pseudo_min_peaks),
                                  "The minimum number of peaks in pseudo-MS/MS "
                                  "spectrum. The default value is 25.")

                    ("ms1-intensity-correlation-cutoff,p",
                     po::value<std::string>(
                         &ms1_seed_env_inte_corr_tole_cutoff),
                     "<a positive number in [0,1]>. Set the MS1 seed envelope "
                     "intensity correlation cutoff value for generating "
                     "extracting features. The default value is 0.5")(
                        "ms2-intensity-correlation-cutoff,P",
                        po::value<std::string>(
                            &ms2_seed_env_inte_corr_tole_cutoff),
                        "<a positive number in [0,1]>. Set the MS2 seed "
                        "envelope intensity correlation cutoff value for "
                        "generating extracting features. The default value is "
                        "0")

                        ("disable-final-filtering,d",
                         "Skip the final filtering of envelopes in MS/MS "
                         "scans.")(
                            "thread-number,u",
                            po::value<std::string>(&thread_number),
                            "<a positive integer>. Number of threads used in "
                            "spectral deconvolution. Default value: 1.");
    ...
    desc.add_options()("help,h", "Print this help message.")(
        ...
        "")("ms2-ecscore-cutoff,T", po::value<std::string>(&ms2_ecscore_cutoff),
            "")("pseudo-cutoff,v", po::value<std::string>(&pseudo_score_cutoff),
                "")("missing-level-one,o", "")("single-scan-noise,i", "")(
        "ms1-min-scan-number,b", po::value<std::string>(&ms1_min_scan_num), "")(
        ...
        "msdeconv,n", "")("disable-final-filtering,d", "")(
        "keep,k",
