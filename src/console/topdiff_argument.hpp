...
#ifndef TOPPIC_CONSOLE_TOPDIFF_ARGUMENT_HPP_
#define TOPPIC_CONSOLE_TOPDIFF_ARGUMENT_HPP_
...
class TopDiffArgument {
 public:
  ...
  static void outputArguments(std::ostream& output, const std::string& sep,
  ...
  std::vector<std::string> getSpectrumFileList() {
    return spectrum_file_list_;
  };
