  ...
  try {
    ...
    display_desc.add_options() 
        ...
        ("proteoform-type,R", po::value<std::string> (&allow_prot_type), 
         "<a list of allowed types of proteoforms>. Four types of proteoforms can be selected: COMPLETE, PREFIX, SUFFIX, and INTERNAL. COMPLETE stands for proteoforms that cover the complete sequence of a protein (NME is allowed), PREFIX for proteoforms that cover the N-terminal part of a protein, SUFFIX for proteoforms that cover the C-terminal part of a protein, and INTERNAL for proteoforms that cover an internal part of a protein. When multiple types are allowed, they are separated by commas. Default value: COMPLETE,PREFIX,SUFFIX,INTERNAL.")
