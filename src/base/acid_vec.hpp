...
class AcidVec {
 public:
   ...
   */
  static AcidPtr getAcidPtrByName(std::vector<AcidPtr> &acid_ptrs, 
   ...
   */
  static AcidPtr getAcidPtrByOneLetter(std::vector<AcidPtr> &acid_ptrs, 
   ...
   */
  static AcidPtr getAcidPtrByThreeLetter(std::vector<AcidPtr> &acid_ptrs, 
                                         const std::string &three_letter);

  /**
   * Checks if the list contains an amino acid with the specific name.
   */
  static bool containsName(std::vector<AcidPtr> &acid_ptrs, 
                           const std::string &name);
   ...
   * representation.
   */
  static bool containsOneLetter(std::vector<AcidPtr> &acid_ptrs, 
                                const std::string &one_letter);
   ...
   * representation.
   */
  static bool containsThreeLetter(std::vector<AcidPtr> &acid_ptrs, 
                                  const std::string &three_letter);
   ...
   */
  static std::vector<AcidPtr> convert(std::vector<AcidPtr> &acid_ptrs, 
