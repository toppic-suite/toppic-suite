...
namespace prot {
AnnoResidue::AnnoResidue(ResiduePtr residue_ptr):Residue(residue_ptr->getAcidPtr(),residue_ptr->getPtmPtr()) {
...
void AnnoResidue::appendViewXml(XmlDOMDocument* xml_doc,xercesc::DOMElement* parent){
