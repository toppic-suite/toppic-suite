...
#ifndef TOPPIC_STAT_LOCAL_LOCAL_MNG_HPP_
#define TOPPIC_STAT_LOCAL_LOCAL_MNG_HPP_
...
class LocalMng {
 public:
  LocalMng(const PrsmParaPtr& prsm_para_ptr, double local_threshold,
           const std::string& residueModFileName, double min_ptm_mass,
...
#endif /* TOPPIC_STAT_LOCAL_LOCAL_MNG_HPP_ */
