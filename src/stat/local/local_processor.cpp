...
LocalProcessor::LocalProcessor(const LocalMngPtr &mng_ptr):
  mng_ptr_(mng_ptr) {
    init();
  }
...
bool LocalProcessor::modifiable(const ProteoformPtr &proteoform_ptr, int i, const PtmPtr &ptm_ptr) {
...
ProteoformPtr LocalProcessor::onePtmLocalize(const ProteoformPtr &base_form_ptr, 
                                             const ExtendMsPtrVec & extend_ms_ptr_vec,
...
bool massShiftOverlap(const ProteoformPtr &form_ptr_1, const ProteoformPtr &form_ptr_2) {
...
int LocalProcessor::compTwoPtmScr(const ProteoformPtr &form_ptr, const ExtendMsPtrVec & extend_ms_ptr_vec,
...
ProteoformPtr LocalProcessor::twoPtmLocalize(const ProteoformPtr &form_ptr, const ExtendMsPtrVec &extend_ms_ptr_vec,
