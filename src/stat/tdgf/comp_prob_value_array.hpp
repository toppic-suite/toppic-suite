...
void compProbArray(const CompProbValuePtr &comp_prob_ptr, const ResFreqPtrVec &n_term_residue_ptrs, 
                   const PrmPeakPtrVec2D &peak_ptr_2d, const PrsmPtrVec &prsm_ptrs, bool strict,
                   double prob_prec_mass, const PeakTolerancePtr &tole_ptr, std::vector<double> &results);
