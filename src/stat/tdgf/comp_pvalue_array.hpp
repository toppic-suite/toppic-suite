...
class CompPValueArray {
 public:
  ...
  void compSingleExpectedValue(const DeconvMsPtrVec &ms_ptr_vec, const PrsmPtr &prsm_ptr, double ppo, 
                               double n_term_label_mass);

  void process(const SpectrumSetPtr &spec_set_ptr, PrsmPtrVec &prsm_ptrs, double ppo, bool is_separate);
