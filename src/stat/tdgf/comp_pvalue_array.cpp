...
CompPValueArray::CompPValueArray(const CountTestNumPtr &test_num_ptr, const TdgfMngPtr &mng_ptr) {
  mng_ptr_ = mng_ptr;
...
void CompPValueArray::process(const SpectrumSetPtr &spec_set_ptr, PrsmPtrVec &prsm_ptrs,
