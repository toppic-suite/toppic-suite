...
int findMatch(const FeaturePrsmPtr &a, FeaturePrsmPtrVec &second, size_t b_index, double mass_tole) {
...
FeaturePrsmPtr findMatchFeature(const FeaturePrsmPtr &feature, FeaturePrsmPtrVec &features, 
                                double mass_tole) {
