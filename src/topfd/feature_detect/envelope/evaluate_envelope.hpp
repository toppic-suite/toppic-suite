...
namespace evaluate_envelope {
    bool preprocess_env(PeakMatrix &peak_matrix, SeedEnvelope &env, FeatureParaPtr para_ptr, double sn_ratio);
    bool evaluate_envelope(PeakMatrix &peak_matrix, SeedEnvelope &seed_envelope, double mass_tol, double corr_tol, double snr);
