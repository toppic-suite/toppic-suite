...
#ifndef TOPPIC_TOPFD_ECSCORE_ENV_COLL_ENV_COLL_ASSIGN_HPP_
#define TOPPIC_TOPFD_ECSCORE_ENV_COLL_ENV_COLL_ASSIGN_HPP_
...
bool checkEnvColl(const MsHeaderPtr &header_ptr, 
                  EnvCollPtrVec &env_coll_list); 
