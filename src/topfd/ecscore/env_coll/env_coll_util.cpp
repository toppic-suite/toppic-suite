...
EnvCollPtr getEnvCollPtr(const MsMapPtr &matrix_ptr, const SeedEnvPtr &seed_ptr,
                         const EnvSetPtr &seed_env_set_ptr, const EcscoreParaPtr &para_ptr,
...
EnvCollPtr findEnvColl(const MsMapPtr &matrix_ptr, const SeedEnvPtr &seed_ptr,
                       const EcscoreParaPtr &para_ptr, double sn_ratio, double split_ratio) {
...
EnvCollPtr findEnvCollWithSingleEnv(const MsMapPtr &matrix_ptr, const SeedEnvPtr &seed_ptr,
                                    const EcscoreParaPtr &para_ptr, double sn_ratio, double split_ratio) {
  EnvSetPtr env_set_ptr = env_set_util::searchEnvSet(matrix_ptr, seed_ptr, para_ptr, sn_ratio);
  if (env_set_ptr == nullptr) {
...
bool checkOverlap(MsMapRowHeaderPtrVec &spectrum_list, const EnvCollPtr &coll_ptr,
...
bool checkExistingFeatures(const MsMapPtr &matrix_ptr, const EnvCollPtr &env_coll_ptr,
                           EnvCollPtrVec &env_coll_list, const EcscoreParaPtr &para_ptr, double sn_ratio) {
...
FracFeaturePtr getFracFeature(int feat_id, DeconvMsPtrVec &ms1_ptr_vec, int frac_id,
                              std::string &file_name, const EnvCollPtr &coll_ptr,
