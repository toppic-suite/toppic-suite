...
void ECScore::assignEnvColls(FracFeaturePtrVec &frac_feature_list,
...
bool ECScore::getHighestInteEnvColl(FracFeaturePtrVec &frac_features, EnvCollPtrVec &env_coll_list,
...
bool ECScore::getNewEnvColl(MsHeaderPtr header_ptr, MsMapPtr matrix_ptr,
