...
MsMapPeakPtrVec  getIntvPeakList(const MsMapPtr &matrix_ptr, const EnvSetPtr &env_set_ptr,
                                 int spec_id) {
...
std::vector<std::vector<float>> getEnvcnnInputMatrix(const MsMapPtr &matrix_ptr,
