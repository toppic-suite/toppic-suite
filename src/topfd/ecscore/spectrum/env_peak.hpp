...
#ifndef TOPPIC_TOPFD_ECSCORE_SPECTRUM_ENV_PEAK_HPP
#define TOPPIC_TOPFD_ECSCORE_SPECTRUM_ENV_PEAK_HPP
...
class EnvPeak : public Peak {
 public:
  ...
  EnvPeak(double pos, double inte);

  EnvPeak(const EnvPeakPtr p);
  ...
  static bool cmpInteDec(EnvPeakPtr a, EnvPeakPtr b) {
    return a->getIntensity() > b->getIntensity(); }

  static bool cmpPosInc(EnvPeakPtr a, EnvPeakPtr b) {
