...
SeedEnvPtr preprocessSeedEnvPtr(const SeedEnvPtr &seed_ptr, const MsMapPtr &ms_map_ptr,
...
SeedEnvPtr relaxProcessSeedEnvPtr(const SeedEnvPtr &seed_ptr, const MsMapPtr &ms_map_ptr,
                                  const EcscoreParaPtr &para_ptr, double sn_ratio) {
  //1. Check charge state
  if (seed_ptr->getCharge() < para_ptr->para_min_charge_) {
    return nullptr;
...
SeedEnvPtr testHalfChargeEnv(const SeedEnvPtr &seed_ptr, const MsMapPtr &ms_map_ptr, 
                             double even_odd_log_ratio, const EcscoreParaPtr &para_ptr, 
                             double sn_ratio) {
