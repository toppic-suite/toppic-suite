...
VertexAPtrVec getVertexAList(const DeconvDataPtr &data, int cur_win, const MatchEnvPtrVec &prev_match_envs, 
                             const MatchEnvPtrVec &cur_match_envs, const DpParaPtr &dp_para_ptr);
...
VertexBPtrVec getVertexBList(const DeconvDataPtr &data, int cur_win,
                             ...
                             MatchEnvPtrVec &cur_match_envs, const DpParaPtr &dp_para_ptr);
};
