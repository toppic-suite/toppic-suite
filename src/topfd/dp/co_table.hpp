...
class CoTable {
 public:
  ...
  static bool checkCoexist(const MatchEnvPtr &env_a, const MatchEnvPtr &env_b, int pos_a,
                                    int pos_b, double tolerance);

  static bool checkCoexist(const MatchEnvPtr &env_a, const MatchEnvPtr &env_b,
                                    double tolerance);
