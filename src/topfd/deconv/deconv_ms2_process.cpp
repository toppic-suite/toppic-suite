...
void deconvMsTwo(MzmlMsPtr ms_ptr, 
  ...
  if (topfd_para_ptr->isGeneHtmlFolder()) {
    std::string json_file_name = topfd_para_ptr->getMs2JsonDir() 
...
void DeconvMs2Process::process() {
  ...
  std::string ms1_prefix = file_util::absoluteName(output_base_name) + "_ms2.msalign_";
