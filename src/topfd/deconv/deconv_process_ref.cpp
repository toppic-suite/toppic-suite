...
void DeconvProcess::processSp(ParameterPtr para_ptr, 
                              RawMsGroupReaderPtr reader_ptr, 
                              MsAlignWriterPtrVec ms1_writer_ptrs, 
                              MsAlignWriterPtrVec ms2_writer_ptrs) {
  ...
  */
  ...
  while (ms_group_ptr != nullptr) {
    ...
    */
    ...
    pool_ptr->Enqueue(geneTask(ms_group_ptr, deconv_ptr, writer_ptr_vec_1, writer_ptr_vec_2));
