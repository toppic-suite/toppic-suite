...
void writeMs1(sqlite3* sql_db, const MzmlMsPtr &ms_ptr, const MatchEnvPtrVec &env,
              double base_inte, double min_ref_inte);

void writeMs2(sqlite3* sql_db, const MzmlMsPtr &ms_ptr, const MatchEnvPtrVec &env);
