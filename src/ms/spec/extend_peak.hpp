...
#ifndef TOPPIC_MS_SPEC_EXTEND_PEAK_HPP_
#define TOPPIC_MS_SPEC_EXTEND_PEAK_HPP_
...
class ExtendPeak : public Peak {
 public:
  ...
  ExtendPeak(const DeconvPeakPtr &base_peak_ptr, double mono_mass, double score);
  ...
  double getOrigTolerance() const {return orig_tolerance_;}

  double getReverseTolerance() const {return reverse_tolerance_;}
