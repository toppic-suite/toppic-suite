...
std::string MsHeader::toString() const {
...
std::string MsHeader::getScansString() const {
...
void MsHeader::appendXml(XmlDOMDocument* xml_doc, XmlDOMElement parent) const {
...
int MsHeader::getFirstPrecCharge() const {
  return getFirstPrecPtr()->getCharge();
}

double MsHeader::getFirstPrecInte() const {
  return getFirstPrecPtr()->getInte();
}

double MsHeader::getFirstPrecMonoMass() const {
  return getFirstPrecPtr()->getMonoMass();
}

int MsHeader::getFirstPrecFeatureId() const {
  return getFirstPrecPtr()->getFeatureId();
}

double MsHeader::getFirstPrecMonoMassMinusWater() const {
  return getFirstPrecPtr()->getMonoMassMinusWater();
}

double MsHeader::getFirstPrecErrorTolerance(double ppo) const {
