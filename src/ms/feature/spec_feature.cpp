...
SpecFeature::SpecFeature(const std::string& line) {
...
SpecFeature::SpecFeature(const MsHeaderPtr& header,
                         const FracFeaturePtr& feature, double prec_mono_mz,
                         double prec_avg_mz, int prec_charge,
                         double prec_inte) {
...
SpecFeature::SpecFeature(double prec_mono_mz, double prec_charge) {
  frac_id_ = 0;
  frac_feature_id_ = -1;
  prec_mono_mz_ = prec_mono_mz;
  prec_charge_ = prec_charge;
