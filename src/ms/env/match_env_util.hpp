...
#ifndef TOPPIC_MS_ENV_MATCH_ENV_UTIL_HPP_
#define TOPPIC_MS_ENV_MATCH_ENV_UTIL_HPP_
...
MatchEnvPtrVec addUnusedMasses(MatchEnvPtrVec& envs, std::vector<PeakPtr>& ms,
                               double tolerance);
...
DeconvMsPtr getDeconvMsPtr(const MsHeaderPtr& header_ptr, MatchEnvPtrVec& envs);
