...
std::vector<int> getSharedPeaks(const ExpEnvPtr &env_a, const ExpEnvPtr &env_b) {
...
int comp(const PeakPtrVec &peak_list, const MatchEnvPtr &a, const MatchEnvPtr &b, double tolerance) {
