...
#ifndef TOPPIC_MS_UTIL_MATRIX_INVERSE_HPP_
#define TOPPIC_MS_UTIL_MATRIX_INVERSE_HPP_
...
// (defined in the header, so inline to avoid ODR violations if included twice)
inline bool InvertMatrix(const boost::numeric::ublas::matrix<double>& input,
...
#endif  // TOPPIC_MS_UTIL_MATRIX_INVERSE_HPP_
