...
namespace toppic {
    PseudoPeaks::PseudoPeaks(double mass, double monoMz, int charge, double intensity, double score, double corr,
                             double shared_inte, int ms2_cycle_span, double apexDiffScan, double rtLow, double rtHigh,
                             int ms2_apex_cycle) {
        mass_ = mass;
        mono_mz_ = monoMz;
        charge_ = charge;
    ...
    PseudoPeaks::PseudoPeaks(const PseudoPeaks &peaks) {
        mass_ = peaks.mass_;
