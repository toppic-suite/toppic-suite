...
#ifndef TOPPIC_TOPDIA_PSEUDO_SPEC_MZRT_FEATURE_HPP_
#define TOPPIC_TOPDIA_PSEUDO_SPEC_MZRT_FEATURE_HPP_
...
class MzrtFeature {
 public:
  ...
  void setInterpolatedXic(std::vector<double> interpolatedXic) {
    interpolated_xic_ = std::move(interpolatedXic);
  }
...
#endif  // TOPPIC_TOPDIA_PSEUDO_SPEC_MZRT_FEATURE_HPP_
