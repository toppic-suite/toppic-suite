...
void process(const std::string& db_file_name, const std::string& spec_file_name,
             ...
             const std::string& output_file_ext, double K1, double K2,
             double pref, double inte) {
  std::string input_file_name =
      file_util::basename(spec_file_name) + "." + input_file_ext;
  ...
  PrsmXmlWriter all_writer(file_util::basename(spec_file_name) + "." +
                           output_file_ext);
