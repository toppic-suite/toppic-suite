...
void PeakIonPair::appendTheoPeakToXml(XmlDOMDocument* xml_doc,
  ...
  std::string disp_pos = std::to_string(theo_peak_ptr_->getIonPtr()->getDisplayPos());
  ...
  str = str_util::fixedToString(error * 1000000 / real_peak_ptr_->getMonoMass(), precision - 2);
