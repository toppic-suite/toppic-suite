...
ProtCandidate::ProtCandidate(int protein_id, int score)
    : protein_id_(protein_id), score_(score) {}
...
// Order by score descending, breaking ties by protein id ascending.
bool protScoreScoreDecProtIdInc(const std::pair<int, int>& a,
...
bool protScorePtrScoreDecProtIdInc(const ProtScorePtr& a,
...
ProtCandidatePtrVec ProtCandidate::geneResults(
