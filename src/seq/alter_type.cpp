...
const AlterTypePtr AlterType::INPUT = std::make_shared<AlterType>(1, "Input");

const AlterTypePtr AlterType::FIXED = std::make_shared<AlterType>(2, "Fixed");
...
void AlterType::appendXml(XmlDOMDocument* xml_doc, XmlDOMElement parent) const {
