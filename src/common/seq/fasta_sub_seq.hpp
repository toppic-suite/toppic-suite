...
#ifndef TOPPIC_COMMON_SEQ_FASTA_SUB_SEQ_HPP_
#define TOPPIC_COMMON_SEQ_FASTA_SUB_SEQ_HPP_
...
class FastaSubSeq : public FastaSeq {
 public:
  ...
  int getSubSeqEnd() const {return sub_seq_end_;}

  bool isNTerm() const {return sub_seq_start_ == 0;}
