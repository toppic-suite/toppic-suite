...
#ifndef TOPPIC_COMMON_SEQ_SEQ_SEGMENT_HPP_
#define TOPPIC_COMMON_SEQ_SEQ_SEGMENT_HPP_
...
class SeqSegment {
 public:
  ...
  double getNTermShift() const {return n_term_shift_;}

  double getCTermShift() const {return c_term_shift_;}
