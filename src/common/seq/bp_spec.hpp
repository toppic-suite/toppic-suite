...
#ifndef TOPPIC_COMMON_SEQ_BP_SPEC_HPP_
#define TOPPIC_COMMON_SEQ_BP_SPEC_HPP_

#include <memory>
#include <vector>

#include "common/seq/break_point.hpp"
#include "common/seq/residue_seq.hpp"
...
class BpSpec {
 public:
  ...
  const BreakPointPtrVec& getBreakPointPtrVec() const {return break_point_ptr_vec_;}

  BreakPointPtr getBreakPointPtr(int i) const {return break_point_ptr_vec_[i];}
  ...
  std::vector<int> getScaledMass(double scale, const IonTypePtr &ion_type_ptr) const;
