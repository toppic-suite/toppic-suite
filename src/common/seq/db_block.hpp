...
#ifndef TOPPIC_COMMON_SEQ_DB_BLOCK_HPP_
#define TOPPIC_COMMON_SEQ_DB_BLOCK_HPP_
...
class DbBlock {
 public:
  ...
  int getBlockIdx() const {return block_index_;}

  int getSeqIdx() const {return seq_index_;}
