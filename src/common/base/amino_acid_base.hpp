...
class AminoAcidBase {
 public:
  ...
  static const AminoAcidPtrVec& getBaseAminoAcidPtrVec() {
    return amino_acid_ptr_vec_;
  }
  ...
  static AminoAcidPtr getAminoAcidPtrByThreeLetter(
 ...
 private:
  ...
  static std::unordered_map<std::string, AminoAcidPtr>
      amino_acid_one_letter_map_;

  static std::unordered_map<std::string, AminoAcidPtr>
      amino_acid_three_letter_map_;
