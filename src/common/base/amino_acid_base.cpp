...
bool AminoAcidBase::containsOneLetter(const std::string &one_letter) {
  return amino_acid_one_letter_map_.find(one_letter) != amino_acid_one_letter_map_.end();
}

bool AminoAcidBase::containsThreeLetter(const std::string &three_letter) {
  return amino_acid_three_letter_map_.find(three_letter) != amino_acid_three_letter_map_.end();
}
