...
class AnnoResidue : public Residue {
 public:
  AnnoResidue(const ResiduePtr &residue_ptr, int pos);

  void appendViewXml(XmlDOMDocument* xml_doc, XmlDOMElement parent);

  static AnnoResiduePtrVec getAnnoResidues(const ProteoformPtr &proteoform_ptr);
