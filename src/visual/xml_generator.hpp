...
#ifndef TOPPIC_VISUAL_XML_GENERATOR_HPP_
#define TOPPIC_VISUAL_XML_GENERATOR_HPP_
...
class XmlGenerator {
 public:
  XmlGenerator(const PrsmParaPtr &prsm_para_ptr,
...
#endif /* TOPPIC_VISUAL_XML_GENERATOR_HPP_ */
