...
AnnoResidue::AnnoResidue(const ResiduePtr &residue_ptr, int pos):
...
void AnnoResidue::appendViewXml(XmlDOMDocument* xml_doc,
  ...
  XmlDOMElement element = xml_doc->addElement(parent, "residue");
...
AnnoResiduePtrVec AnnoResidue::getAnnoResidues(const ProteoformPtr &proteoform_ptr) {
