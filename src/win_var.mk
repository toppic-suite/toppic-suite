...
#
INCLUDES = -I../../thirdparty/windows_include/ -I../  
#
# define library paths in addition to /usr/lib
LFLAGS = -L../../thirdparty/windows_lib/ -L/lib -L/opt/local/lib 
#
# define any libraries to link into executable:
LIBS = -lxalan-c -lxalanMsg -lxerces-c -lboost_filesystem-mgw48-1_55 -lboost_system-mgw48-1_55 -lboost_program_options-mgw48-1_55
...
XPP_OBJS = $(addprefix $(OBJ_DIR)/, transformer.o anno_view.o xml_generator.o ) 
