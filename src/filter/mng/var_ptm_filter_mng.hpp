...
class VarPtmFilterMng {
 public:
  VarPtmFilterMng(const PrsmParaPtr& prsm_para_ptr,
                  const std::string& index_file_para,
                  const std::string& var_mod_file_name, int var_ptm_num,
                  int thread_num, bool use_approx_spec,
                  const std::string& output_file_ext);

  static std::vector<int> computeShifts(
      std::vector<int>& round_single_shift_list, int var_ptm_num);
