...
class DiagFilterMng {
 public:
  DiagFilterMng(const PrsmParaPtr& prsm_para_ptr,
                const std::string& index_file_para, int filtering_result_num,
                int thread_num, const std::string& output_file_ext,
                const std::string& residue_mod_file_name = "", int var_num = 0);
