...
#ifndef TOPPIC_FILTER_VARPTM_VAR_PTM_FILTER_HPP_
#define TOPPIC_FILTER_VARPTM_VAR_PTM_FILTER_HPP_
...
class VarPtmFilter {
 public:
  VarPtmFilter(const ProteoformPtrVec& proteo_ptrs,
               const VarPtmFilterMngPtr& mng_ptr, std::string block_str);
