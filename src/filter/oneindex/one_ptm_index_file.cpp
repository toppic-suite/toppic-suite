...
void geneOnePtmIndexFile(const ProteoformPtrVec &proteo_ptrs,
  ...
  MassMatchPtr term_index_ptr = mass_match_factory::getPrmTermMassMatchPtr(proteo_ptrs, shift_2d,
                                                                           mng_ptr->max_proteoform_mass_,
                                                                           mng_ptr->filter_scale_);
  MassMatchPtr diag_index_ptr = mass_match_factory::getPrmDiagMassMatchPtr(proteo_ptrs,
                                                                           mng_ptr->max_proteoform_mass_,
                                                                           mng_ptr->filter_scale_);
