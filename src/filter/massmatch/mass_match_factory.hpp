...
#ifndef TOPPIC_FILTER_MASSMATCH_MASS_MATCH_FACTORY_HPP_
#define TOPPIC_FILTER_MASSMATCH_MASS_MATCH_FACTORY_HPP_
...
MassMatchPtr getPrmTermMassMatchPtr(
    const ProteoformPtrVec& proteo_ptrs,
    std::vector<std::vector<double>>& real_shift_2d, double max_proteoform_mass,
    double scale);
