...
DiagonalHeaderPtrVec PtmSlowMatch::getNTermShiftList(
  ...
  // get protein N term shift (only one)
  DiagonalHeaderPtr n_term_shift_comp_left = getNTermShiftListCompLeft(seq,mng);
  headers.push_back(n_term_shift_comp_left);
  // get protein C term shift (only one)
  DiagonalHeaderPtr n_term_shift_comp_right = getNTermShiftListCompRight(seq,ms_six);
  headers.push_back(n_term_shift_comp_right);
