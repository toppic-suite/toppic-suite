...
DiagonalHeaderPtr getNTermShiftListCompLeft(ProteoformPtr seq,PtmMngPtr mng);
DiagonalHeaderPtr getNTermShiftListCompRight(ProteoformPtr seq,PrmMsPtr ms_six);
