...
##        el.write(self.writer)
    def write_peptide(self, spec):
        el = self.Peptide(
            peptide_sequence=spec['peptide_sequence'], id=spec['id'], modifications=spec['modifications'])
        el.write(self.writer)
    ...
    def spectrum_identification_item(self, experimental_mass_to_charge,
                                     charge_state, peptide_id, peptide_evidence_id, id,
        ...
        return self.SpectrumIdentificationItem(
            ...
            peptide_evidence_ids=peptide_evidence_id, id=id,
