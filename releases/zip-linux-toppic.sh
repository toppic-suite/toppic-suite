...
cp /usr/lib/x86_64-linux-gnu/libboost_program_options.so.1.71.0 toppic-linux-${1}/toppic_resources/lib/
cp /usr/lib/x86_64-linux-gnu/libboost_filesystem.so.1.71.0 toppic-linux-${1}/toppic_resources/lib/
cp /usr/lib/x86_64-linux-gnu/libboost_system.so.1.71.0 toppic-linux-${1}/toppic_resources/lib/
cp /usr/lib/x86_64-linux-gnu/libboost_thread.so.1.71.0 toppic-linux-${1}/toppic_resources/lib/
cp /usr/lib/x86_64-linux-gnu/libboost_serialization.so.1.71.0 toppic-linux-${1}/toppic_resources/lib/
cp /usr/lib/x86_64-linux-gnu/libboost_iostreams.so.1.71.0 toppic-linux-${1}/toppic_resources/lib/
cp /usr/lib/x86_64-linux-gnu/libboost_chrono.so.1.71.0 toppic-linux-${1}/toppic_resources/lib/

cp /usr/lib/x86_64-linux-gnu/libxerces-c-3.2.so toppic-linux-${1}/toppic_resources/lib/
cp /usr/lib/x86_64-linux-gnu/libicuuc.so.66 toppic-linux-${1}/toppic_resources/lib/
cp /usr/lib/x86_64-linux-gnu/libicudata.so.66 toppic-linux-${1}/toppic_resources/lib/
