 ...
 */
function setMassErrorValue(massErrorthVal: number): void{
 ...
 */
function setPPMErrorValue(ppmErrorthVal: number): void{
 ...
 */
function writeMassErrorThreshholdValueToUI(massErrorthVal: number, ppmErrorthVal: number): void{
